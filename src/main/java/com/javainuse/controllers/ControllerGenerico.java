...
import com.javainuse.services.IservicioGenerico;
...
public class ControllerGenerico<E, S extends IservicioGenerico<E>> {
   ...
   @PostMapping("/")
    @Transactional
    public ResponseEntity<?> post(@RequestBody E instrumentoForm) {
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<?> put(@PathVariable long id, @RequestBody E instrumentoForm) {
